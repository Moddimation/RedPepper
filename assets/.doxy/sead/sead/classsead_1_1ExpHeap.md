...
[**ClassList**](annotated.md) **>** [**sead**](namespacesead.md) **>** [**ExpHeap**](classsead_1_1ExpHeap.md)
...
| virtual s32 | [**destroyAndGetAllocatableSize**](#function-destroyandgetallocatablesize) (s32) <br> |
...
|  u8 | [**getAllocMode**](#function-getallocmode) () const<br> |
...
|  void | [**setAllocMode**](#function-setallocmode) (u8 mode) <br> |
| virtual void | [**setFindFreeBlockMode**](#function-setfindfreeblockmode) (FindFreeBlockMode mode) <br> |
...
| Type | Name |
| ---: | :--- |
|  [**ExpHeap**](classsead_1_1ExpHeap.md) \* | [**create**](#function-create-12) (size\_t size, const [**SafeString**](classsead_1_1SafeStringBase.md) & name, [**Heap**](classsead_1_1Heap.md) \* parent, HeapDirection direction, bool) <br> |
|  [**ExpHeap**](classsead_1_1ExpHeap.md) \* | [**create**](#function-create-22) (void \* address, size\_t size, const [**SafeString**](classsead_1_1SafeStringBase.md) & name, bool) <br> |
|  size\_t | [**getManagementAreaSize**](#function-getmanagementareasize) (s32) <br> |
|  [**ExpHeap**](classsead_1_1ExpHeap.md) \* | [**tryCreate**](#function-trycreate-12) (size\_t size, const [**SafeString**](classsead_1_1SafeStringBase.md) & name, [**Heap**](classsead_1_1Heap.md) \* parent, HeapDirection direction, bool) <br> |
|  [**ExpHeap**](classsead_1_1ExpHeap.md) \* | [**tryCreate**](#function-trycreate-22) (void \* address, size\_t size, const [**SafeString**](classsead_1_1SafeStringBase.md) & name, bool) <br> |
...
| Type | Name |
| ---: | :--- |
|  u8 | [**mAllocMode**](#variable-mallocmode)  <br> |
|  u8 | [**mFindFreeBlockMode**](#variable-mfindfreeblockmode)  <br> |
|  [**MemBlockList**](classsead_1_1OffsetList.md) | [**mFreeList**](#variable-mfreelist)  <br> |
|  [**MemBlockList**](classsead_1_1OffsetList.md) | [**mUseList**](#variable-muselist)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**ExpHeap**](#function-expheap) (const [**SafeString**](classsead_1_1SafeStringBase.md) & name, [**Heap**](classsead_1_1Heap.md) \* parent, void \* address, size\_t size, HeapDirection direction, bool) <br> |
|  size\_t | [**adjustBack\_**](#function-adjustback_) () <br> |
|  size\_t | [**adjustFront\_**](#function-adjustfront_) () <br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**allocFromHead\_**](#function-allocfromhead_-12) (size\_t) <br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**allocFromHead\_**](#function-allocfromhead_-22) (size\_t, s32) <br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**allocFromTail\_**](#function-allocfromtail_-12) (size\_t) <br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**allocFromTail\_**](#function-allocfromtail_-22) (size\_t, s32) <br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**findFirstMemBlockIfFree\_**](#function-findfirstmemblockiffree_) () <br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**findFreeMemBlockFromHead\_**](#function-findfreememblockfromhead_-12) (size\_t, FindMode) const<br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**findFreeMemBlockFromHead\_**](#function-findfreememblockfromhead_-22) (size\_t, s32, FindMode) const<br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**findFreeMemBlockFromTail\_**](#function-findfreememblockfromtail_-12) (size\_t, FindMode) const<br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**findFreeMemBlockFromTail\_**](#function-findfreememblockfromtail_-22) (size\_t, s32, FindMode) const<br> |
|  [**MemBlock**](classsead_1_1MemBlock.md) \* | [**findLastMemBlockIfFree\_**](#function-findlastmemblockiffree_) () <br> |
|  void | [**pushToFreeList\_**](#function-pushtofreelist_) ([**MemBlock**](classsead_1_1MemBlock.md) \*) <br> |
|  void | [**pushToUseList\_**](#function-pushtouselist_) ([**MemBlock**](classsead_1_1MemBlock.md) \*) <br> |
...
| Type | Name |
| ---: | :--- |
|  s32 | [**compareMemBlockAddr\_**](#function-comparememblockaddr_) (const [**MemBlock**](classsead_1_1MemBlock.md) \*, const [**MemBlock**](classsead_1_1MemBlock.md) \*) <br> |
|  void | [**createMaxSizeFreeMemBlock\_**](#function-createmaxsizefreememblock_) ([**ExpHeap**](classsead_1_1ExpHeap.md) \*) <br> |
|  void | [**doCreate**](#function-docreate) ([**ExpHeap**](classsead_1_1ExpHeap.md) \*, [**Heap**](classsead_1_1Heap.md) \*) <br> |
...
Implements [*sead::Heap::tryRealloc*](classsead_1_1Heap.md#function-tryrealloc)
