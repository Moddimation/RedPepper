...
static const ExecuteOrder split(sDraw1ExecuteOrder) = {"２Ｄエンドロールテキスト", "LayoutDraw", 64,
                                                       "レイアウト"};
static const ExecuteOrder split(sDraw2ExecuteOrder) = {"固定地形", "ActorModelDrawModelCache", 32,
                                                       "地形"};
static const ExecuteOrder split(sDraw3ExecuteOrder) = {"コリジョン地形", "ActorModelDraw", 128,
                                                       "地形"};
static const ExecuteOrder split(sDraw4ExecuteOrder) = {"２Ｄアイコン", "LayoutDraw", 128,
                                                       "レイアウト"};
static const ExecuteOrder split(sDraw5ExecuteOrder) = {"２Ｄベース", "LayoutDraw", 128,
                                                       "レイアウト"};
static const ExecuteOrder split(sDraw6ExecuteOrder) = {"２Ｄポーズ", "LayoutDraw", 8, "レイアウト"};
static const ExecuteOrder split(sDraw7ExecuteOrder) = {"２Ｄベース（下画面）", "LayoutDrawBottom",
                                                       8, "レイアウト"};
static const ExecuteOrder split(sDraw8ExecuteOrder) = {"アイテムストックモデル", "ActorModelDraw",
                                                       32, "アイテム"};
static const ExecuteOrder split(sDraw9ExecuteOrder) = {"２Ｄポーズ（下画面）", "LayoutDrawBottom",
                                                       8, "レイアウト"};
