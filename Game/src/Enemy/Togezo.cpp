...
static WalkerStateParam split(sTogezoWalkerStateParam)(4.0, 0.98, 0.85, 250.0, 700.0, 180.0, 70.0,
                                                       150.0);
static WalkerStateWanderParam split(sTogezoWalkerStateWanderParam)(30, 90, 0.7, 4.0, 10.0, "Walk",
                                                                   "Wait");
static WalkerStateChaseParam split(sTogezoWalkerStateChaseParam)(false, true, 1.3, 30.0, 150.0, 3.0,
                                                                 20.0, "Run", "Wait");
...
void Togezo::init(const al::ActorInitInfo& info) {
    ...
    mWanderState = new WalkerStateWander(this, al::getFrontPtr(this), &sTogezoWalkerStateParam,
                                         &sTogezoWalkerStateWanderParam);
    mChaseState = new WalkerStateChase(this, al::getFrontPtr(this), &sTogezoWalkerStateParam,
                                       &sTogezoWalkerStateChaseParam, false);
...
extern "C" bool FUN_00262988(al::LiveActor*, sead::Vector3f* out, const sead::Vector3f&,
                             float);  // turn (?)
