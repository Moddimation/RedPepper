...
[**ClassList**](annotated.md) **>** [**sead**](namespacesead.md) **>** [**Random**](classsead_1_1Random.md)
...
|   | [**Random**](#function-random-23) (u32 seed) <br> |
|   | [**Random**](#function-random-33) (u32 seed\_x, u32 seed\_y, u32 seed\_z, u32 seed\_w) <br> |
|  bool | [**getBool**](#function-getbool) () <br>_Generate a random boolean._  |
|  void | [**getContext**](#function-getcontext) (u32 \* x, u32 \* y, u32 \* z, u32 \* w) const<br> |
|  f32 | [**getF32**](#function-getf32) () <br>_Generate a random f32 in [0, 1)._  |
|  f32 | [**getF32Range**](#function-getf32range) (f32 a, f32 b) <br>_Generate a random f32 in [a, b)._  |
|  f64 | [**getF64**](#function-getf64) () <br>_Generate a random f64 in [0, 1)._  |
|  f64 | [**getF64Range**](#function-getf64range) (f64 a, f64 b) <br>_Generate a random f64 in [a, b)._  |
|  s32 | [**getS32Range**](#function-gets32range) (s32 a, s32 b) <br> |
|  s64 | [**getS64Range**](#function-gets64range) (s64 a, s64 b) <br> |
|  u32 | [**getU32**](#function-getu32-12) () <br>_Generate a random u32._  |
|  u32 | [**getU32**](#function-getu32-22) (u32 max) <br>_Generate a random u32 in [0 .. max)._  |
|  u64 | [**getU64**](#function-getu64) () <br>_Generate a random u64._  |
|  void | [**init**](#function-init-13) () <br>_Reset and seed the engine with the current system tick count._  |
|  void | [**init**](#function-init-23) (u32 seed) <br>_Reset and seed the engine with the specified value._  |
|  void | [**init**](#function-init-33) (u32 seed\_x, u32 seed\_y, u32 seed\_z, u32 seed\_w) <br> |
