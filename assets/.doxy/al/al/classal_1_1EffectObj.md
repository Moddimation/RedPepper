...
[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**EffectObj**](classal_1_1EffectObj.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EffectObj**](#function-effectobj) ([**const**](structal_1_1NameToCreator.md) sead::SafeString & name) <br> |
...
Implements [*al::LiveActor::control*](classal_1_1LiveActor.md#function-control)
...
Implements [*al::LiveActor::getBaseMtx*](classal_1_1LiveActor.md#function-getbasemtx)
...
Implements [*al::LiveActor::kill*](classal_1_1LiveActor.md#function-kill)
...
Implements [*al::LiveActor::makeActorAppeared*](classal_1_1LiveActor.md#function-makeactorappeared)
